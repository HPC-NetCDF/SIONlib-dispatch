 ...
 */
int
AB_set_base_pe(int ncid, int pe)
{
   return NC_ENOTNC3;
}
 ...
 */
int
AB_inq_base_pe(int ncid, int *pe)
{
   return NC_ENOTNC3;
}
 ...
 */
int
SION_inq_format(int ncid, int *formatp)
{
   NC *nc;
 ...
 */
int
SION_inq_format_extended(int ncid, int *formatp, int *modep)
{
   NC *nc;
